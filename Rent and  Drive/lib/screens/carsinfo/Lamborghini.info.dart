...
class Lamborghini_info extends StatefulWidget {
  const Lamborghini_info({super.key});

  @override
  State<Lamborghini_info> createState() => Lamborghini_infoState();
}

class Lamborghini_infoState extends State<Lamborghini_info> {
