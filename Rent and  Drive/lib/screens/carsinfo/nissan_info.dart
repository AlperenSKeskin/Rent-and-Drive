...
class Nissan_info extends StatefulWidget {
  const Nissan_info({super.key});

  @override
  State<Nissan_info> createState() => Nissan_infoState();
}

class Nissan_infoState extends State<Nissan_info> {
